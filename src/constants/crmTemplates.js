...
const TEMPLATES = {
  quote_followup: ({ customerName, orderNumber }) =>
    `سلام ${customerName} عزیز،\nدر خصوص سفارش ${orderNumber} و قیمت اعلام‌شده خواستم پیگیری کنم.\nدر صورت نیاز به راهنمایی یا اصلاح سفارش در خدمت شما هستیم.\nهینزا پلیمر`,
  ...
  order_followup: ({ customerName, orderNumber }) =>
    `سلام ${customerName} عزیز،\nدر خصوص سفارش ${orderNumber} جهت پیگیری با شما در تماس هستیم.\nدر صورت نیاز به هماهنگی بیشتر در خدمت شما هستیم.\nهینزا پلیمر`,
